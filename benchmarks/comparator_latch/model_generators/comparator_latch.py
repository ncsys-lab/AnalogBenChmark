...
from pythams.core.expr import RealType, VarAssign, Constant, Reciprocal, Integrate
...
class StateMaker:
    ...
    def create_precharge_state():
        ...
        n = precharge.block.decl_var('n', blocklib.VarKind.Input, RealType(-1, 1.7, 0.01))
        p = precharge.block.decl_var('p', blocklib.VarKind.Input, RealType(-1, 3.3, 0.01))
        o    = precharge.block.decl_var('o',  blocklib.VarKind.StateVar, RealType(-1, 3.3, 0.01))  
        out  = precharge.block.decl_var('out',  blocklib.VarKind.Output, o.type)
    ...
    def create_evaluate_wait_high_low_state(fsm):
        ...
        n = evaluate_wait_high_low.block.decl_var('n', blocklib.VarKind.Input, RealType(-1, 3.3, 0.001))
        p = evaluate_wait_high_low.block.decl_var('p', blocklib.VarKind.Input, RealType(-1, 3.3, 0.001))
        o    = evaluate_wait_high_low.block.decl_var('o',  blocklib.VarKind.StateVar, RealType(-1, 3.3, 0.01))  
        out  = evaluate_wait_high_low.block.decl_var('out',  blocklib.VarKind.Output, o.type)
    ...
    def create_evaluate_wait_low_high_state(fsm):
        ...
        n = evaluate_wait_low_high.block.decl_var('n', blocklib.VarKind.Input, RealType (-1, 3.3, 0.01))
        p = evaluate_wait_low_high.block.decl_var('p', blocklib.VarKind.Input, RealType (-1, 3.3, 0.01))
        o    = evaluate_wait_low_high.block.decl_var('o',  blocklib.VarKind.StateVar, RealType(-1, 3.3, 0.1))  
        out  = evaluate_wait_low_high.block.decl_var('out',  blocklib.VarKind.Output, o.type)
    ...
    def create_evaluate_low_low_high_state(timestep):
        ...
        n = evaluate_low_low_high.block.decl_var('n', blocklib.VarKind.Input, RealType(-1, 3.3, 0.01))
        p = evaluate_low_low_high.block.decl_var('p', blocklib.VarKind.Input, RealType(-1, 3.3, 0.01))
        o    = evaluate_low_low_high.block.decl_var('o',  blocklib.VarKind.StateVar, RealType(-1, 3.7, 1e-9))  
        out  = evaluate_low_low_high.block.decl_var('out',  blocklib.VarKind.Output, o.type)
...
class GenerateComparatorLatch:
    ...
    def generate_block_model():
        ...
        initial_conditions = fsmlib.Initializer({'n': 2, 'p': 1.6, 'o': 3.3})
